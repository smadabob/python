...
class createmainwin(QWidget):
    ...
    def initUI(self):
        ...
        progresstext = QTextEdit()
        progresstext.setReadOnly(True)
        ...
        gobutton.clicked.connect(lambda: buttonact(gobutton, progresstext))
...
def gitbackup(gobutton, progresstext):
    gobutton.setStyleSheet("background-color: gray")
    gobutton.repaint()
    progresstext.append("Working...\n")
    ...
    progresstext.append("making copy of folder...\n")
    progresstext.repaint()
    ...
    progresstext.append("pushing to github...\n")
    progresstext.repaint()
    ...
    progresstext.append("Finished!")
    progresstext.repaint()
    gobutton.setStyleSheet("background-color: aqua")
    gobutton.repaint()
